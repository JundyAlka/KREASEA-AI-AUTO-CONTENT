...
// Tampil di pojok kanan atas setiap screen AI
// ══════════════════════════════════════════════════════════════
...
class CreditBadge extends ConsumerWidget {
  ...
  void _showCreditDetail(BuildContext context, WidgetRef ref, UserCredits credits) {
...
class CreditDetailSheet extends StatelessWidget {
  ...
  const CreditDetailSheet({super.key, required this.credits, required this.ref});
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: credits.plan == 'premium'
                  ...
                  : credits.plan == 'pro'
                      ? const LinearGradient(colors: [Color(0xFF7C4DFF), Color(0xFFE040FB)])
          ...
          if (credits.plan == 'free') ...[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: const Color(0xFF7C4DFF).withOpacity(0.35), blurRadius: 12, offset: const Offset(0, 4))],
              ),
              child: ElevatedButton.icon(
                onPressed: () => Navigator.pop(context),
                icon: const Icon(Icons.diamond_rounded, size: 18),
                label: const Text('Upgrade Pro — Lebih Banyak Credit', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: isEmpty ? Colors.red.withOpacity(0.3) : color.withOpacity(0.3)),
                ),
                child: Text(
                  '$current/$max',
                  style: TextStyle(
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                isEmpty ? Colors.red.withOpacity(0.5) : isLow ? Colors.orange : color,
              ),
            ),
          ),
          if (isEmpty)
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.info_outline_rounded, size: 12, color: Colors.red.withOpacity(0.7)),
                  const SizedBox(width: 4),
                  const Text('Credit habis. Reset otomatis besok pagi.', style: TextStyle(fontSize: 10, color: Colors.redAccent)),
                ],
              ),
            ),
        ],
...
Future<bool> showCreditGuard(BuildContext context, CreditType type, WidgetRef ref) async {
  ...
  if (hasCredit) return true; // lanjutkan
    ...
    builder: (ctx) => AlertDialog(
      ...
      title: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.bolt_rounded, color: Colors.redAccent, size: 22),
          ),
          const SizedBox(width: 12),
          const Expanded(
            child: Text('Credit Habis', style: TextStyle(color: Colors.white, fontSize: 16)),
          ),
        ],
      ),
      content: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.refresh_rounded, color: Colors.greenAccent, size: 18),
      ...
      actions: [
        TextButton(
          ...
          child: const Text('Tutup', style: TextStyle(color: Colors.white38)),
        ),
        ElevatedButton.icon(
          onPressed: () => Navigator.pop(ctx),
